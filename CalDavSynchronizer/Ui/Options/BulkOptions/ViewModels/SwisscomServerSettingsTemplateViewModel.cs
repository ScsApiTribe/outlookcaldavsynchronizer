...
{
  internal class SwisscomServerSettingsTemplateViewModel : ViewModelBase, IServerSettingsTemplateViewModel
  {
    ...
    public SwisscomServerSettingsTemplateViewModel(IOutlookAccountPasswordProvider outlookAccountPasswordProvider)
    {
